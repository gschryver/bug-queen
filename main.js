...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CHAPTER 4. BUG QUEEN
const ramona = hailTheQueen("Ramona") // Undefined due to no argument. Part 2: added argument to fix error "undefined"
console.log(ramona) 

// CHAPTER 4 - SYNTACTICAL ERRORS
const monica = hailTheQueen("Monica Dinglehopper") // syntax error (not defined) due to function name being mispelled as "Quen" > changed to "Queen"
console.log(monica)
